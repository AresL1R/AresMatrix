...
// ------------------- Stahování obrázků a animovaných snímků -------------------
// Tento příklad pracuje s velikostí matice 16x16 - takové obrázky jsou připraveny v tomto souboru
// pro jiné velikosti matic - připravte si vlastní obrázky
...
void animation(byte n) {
  // "n" - index v sadě animací (připravené obrázky)
  if (loadingFlag) {
    loadingFlag = false;
    modeCode = MC_IMAGE;
    frameNum = 0;
