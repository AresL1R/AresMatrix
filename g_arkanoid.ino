...
void shelfRight() {
  ...
  if (shelf_x > shelfMAX) { 
    ...
    drawPixelXY(shelf_x - 1, 0, CRGB::Black);   
    drawPixelXY(shelf_x + SHELF_LENGTH - 1, 0, GLOBAL_COLOR_2);  
    FastLED.show();
  }
}
...
void shelfLeft() {
  ...
  if (shelf_x < 0) { 
    ...
    drawPixelXY(shelf_x, 0, GLOBAL_COLOR_2);   
    drawPixelXY(shelf_x + SHELF_LENGTH, 0, CRGB::Black);  
    FastLED.show();
  }
}
